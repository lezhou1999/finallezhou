...
void InsertTests(){
	...
	ll->insert(0, 0);
	assert(num_ll_to_string(ll) == "[0, 2147483657, 5, 6, 35]");

	ll->insert(5, 0);
	assert(num_ll_to_string(ll) == "[0, 2147483657, 5, 6, 35, 0]");
	
	ll->insert(1, 1);
	assert(num_ll_to_string(ll) == "[0, 1, 2147483657, 5, 6, 35, 0]");

	ll->insert(2, 2);
	assert(num_ll_to_string(ll) == "[0, 1, 2, 2147483657, 5, 6, 35, 0]");
